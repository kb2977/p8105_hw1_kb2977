...
My vector created above has a dataset size of `r length(prob2_df)`, a mean of `r mean(prob2_df$x)`, a median of `r median(prob2_df$x)`, and a proportion of cases `r mean(prob2_df$log_vec)`.
