...
My factor vector created above has `r length(prob2_df$fac_vec)`, a mean of `r mean(prob2_df$x)`, a median of `median(prob2_df$x)`, and a proportion of cases `r mean(prob2_df$log_vec)`.
